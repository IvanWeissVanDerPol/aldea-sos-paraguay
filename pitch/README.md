...
- `one-pager-paraguai.md` — what's in it for ParaguAI / Aiw team
- `one-pager-sos-py.md` — what's in it for Aldea SOS Paraguay
- `one-pager-corporate-ally.md` — what's in it for Tigo/Itaú/Ueno/Areté
