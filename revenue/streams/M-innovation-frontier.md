...
- Independent safeguarding ombudsperson
...
**Day 0-30 (immediate)**:
1. Fix /transparencia page → 5-day project
2. Activate Meta Donate button → 7-day project
3. Apply for Google Ad Grants → 14-day project
4. Sign up Donorbox → 7-day project
5. Register on Daffy DAF platform → 7-day project
...
*Compiled by Hermes agent (IvanWeissVanDerPol repo). Currency: Gs. 7,300 = USD 1.