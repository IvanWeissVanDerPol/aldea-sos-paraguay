...
### 3. Active volunteer pipeline
TECHO is volunteer-led. Their pipeline:
- Awareness (IG/FB)
- Application (form)
- Interview (in-person)
- Build day (event)
...
- sanlorenzohoy.com Sept 2024 (10k+ beneficiaries story)

---

*See also [`../../../05-revenue/streams/F-events.md`](../../../05-revenue/streams/F-events.md) for the Colecta-style event model.*