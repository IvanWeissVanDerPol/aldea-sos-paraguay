...
(function() {
  ...
  if (!document.querySelector('.whatsapp-fab')) {
    ...
    waFab.href = 'https://wa.me/595983836906?text=Hola%21%20Quiero%20m%C3%A1s%20informaci%C3%B3n%20sobre%20Aldea%20SOS%20Paraguay';
    waFab.className = 'whatsapp-fab';
    waFab.setAttribute('aria-label', 'Contactar por WhatsApp');
    ...
    waFab.innerHTML = `
      ...
      <span class="wa-fab-tooltip">¡Hola! ¿Querés hablar con nosotros?</span>
    `;
